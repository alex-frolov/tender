...
/**
 * Voter права на дашборд/аналитику (AM-13, FR-1.5.10/1.5.15): делегирует
 * проверку PermissionCheckerInterface::can('dashboard.view'). Проверяем:
...
final class DashboardVoterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->voter = new DashboardVoter($this->permissions);
    }
    ...
    public function testGrantedWhenPermissionAllows(): void
    {
        ...
        self::assertSame(
            ...
            $this->vote(DashboardVoter::VIEW, $this->token($user)),
        );
    }
    ...
    public function testDeniedForAnonymous(): void
    {
        self::assertSame(
            VoterInterface::ACCESS_DENIED,
            $this->vote(DashboardVoter::VIEW, $this->token(null)),
        );
    }
