 ...
 *
 * Детекция переходов в stalled (observability-roadmap.md #5, вариант A):
...
final class GaugeMetricsUpdater
{
    ...
    private function update(): void
    {
        ...
        // Переходы в stalled — атомарно через Redis-SET (observability-roadmap.md
        // #5, вариант A). SADD возвращает число ДОБАВЛЕННЫХ элементов = число
