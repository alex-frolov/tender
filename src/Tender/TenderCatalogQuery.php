...
/**
 * Публичный read-контракт каталога тендеров (FR-1.1.1, AR-6).
 *
 * Read-модель для GET /tenders: срез видимых компании тендеров (TenderVisibility:
 * свои + чужие опубликованные открытые + чужие закрытые по договору) с keyset-пагинацией
...
{
    /**
     * Страница каталога тендеров, видимых компании.
     *
