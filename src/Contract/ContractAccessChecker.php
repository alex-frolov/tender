 ...
 * заявки, Auction на входе в торги, Tender на входе) — только через этот
 * интерфейс (границы модулей, PHPArkitect rule 6). Реализация —
 * App\Contract\Service\ContractAccessChecker.
 */
interface ContractAccessChecker
{
    /**
     * @throws Exception\ClosedTenderAccessException если нет действующего
     *                                               multi_use-договора с
     *                                               заказчиком (409 access_denied)
     */
